...
glMultiDrawElements > n i *i i *x i                : void glMultiDrawElements (GLenum, GLsizei *, GLenum, void **, GLsizei);
...
glFogCoordPointer > n i i *x                       : void glFogCoordPointer (GLenum, GLsizei, void *);
...
glSecondaryColorPointer > n i i i *x               : void glSecondaryColorPointer (GLint, GLenum, GLsizei, void *);
...
glBufferData > n i x *x i                          : void glBufferData (GLenum, GLsizeiptr, void *, GLenum);
glBufferSubData > n i x x *x                       : void glBufferSubData (GLenum, GLintptr, GLsizeiptr, void *);
...
glVertexAttribPointer > n i i i s i *x             : void glVertexAttribPointer (GLuint, GLint, GLenum, GLboolean, GLsizei, void *);
...
glVertexAttribIPointer > n i i i i *x              : void glVertexAttribIPointer (GLuint, GLint, GLenum, GLsizei, void *);
...
glDrawElementsInstanced > n i i i *x i             : void glDrawElementsInstanced (GLenum, GLsizei, GLenum, void *, GLsizei);
...
glDrawElementsBaseVertex > n i i i *x i            : void glDrawElementsBaseVertex (GLenum, GLsizei, GLenum, void *, GLint);
glDrawRangeElementsBaseVertex > n i i i i i *x i   : void glDrawRangeElementsBaseVertex (GLenum, GLuint, GLuint, GLsizei, GLenum, void *, GLint);
glDrawElementsInstancedBaseVertex > n i i i *x i i : void glDrawElementsInstancedBaseVertex (GLenum, GLsizei, GLenum, void *, GLsizei, GLint);
glMultiDrawElementsBaseVertex > n i *i i *x i *i   : void glMultiDrawElementsBaseVertex (GLenum, GLsizei *, GLenum, void **, GLsizei, GLint *);
...
glDrawArraysIndirect > n i *x                      : void glDrawArraysIndirect (GLenum, void *);
glDrawElementsIndirect > n i i *x                  : void glDrawElementsIndirect (GLenum, GLenum, void *);
...
glShaderBinary > n i *i i *x i                     : void glShaderBinary (GLsizei, GLuint *, GLenum, void *, GLsizei);
...
glProgramBinary > n i i *x i                       : void glProgramBinary (GLuint, GLenum, void *, GLsizei);
...
glVertexAttribLPointer > n i i i i *x              : void glVertexAttribLPointer (GLuint, GLint, GLenum, GLsizei, void *);
...
glDepthRangeArrayv > n i i *d                      : void glDepthRangeArrayv (GLuint, GLsizei, GLdouble *);
...
glClearBufferData > n i i i i *x                   : void glClearBufferData (GLenum, GLenum, GLenum, GLenum, void *);
glClearBufferSubData > n i i x x i i *x            : void glClearBufferSubData (GLenum, GLenum, GLintptr, GLsizeiptr, GLenum, GLenum, void *);
...
glInvalidateFramebuffer > n i i *i                 : void glInvalidateFramebuffer (GLenum, GLsizei, GLenum *);
glInvalidateSubFramebuffer > n i i *i i i i i      : void glInvalidateSubFramebuffer (GLenum, GLsizei, GLenum *, GLint, GLint, GLsizei, GLsizei);
glMultiDrawArraysIndirect > n i *x i i             : void glMultiDrawArraysIndirect (GLenum, void *, GLsizei, GLsizei);
glMultiDrawElementsIndirect > n i i *x i i         : void glMultiDrawElementsIndirect (GLenum, GLenum, void *, GLsizei, GLsizei);
glGetProgramInterfaceiv > n i i i *i               : void glGetProgramInterfaceiv (GLuint, GLenum, GLenum, GLint *);
glGetProgramResourceIndex > i i i *c               : GLuint glGetProgramResourceIndex (GLuint, GLenum, GLchar *);
glGetProgramResourceName > n i i i i *i *c         : void glGetProgramResourceName (GLuint, GLenum, GLuint, GLsizei, GLsizei *, GLchar *);
glGetProgramResourceiv > n i i i i *i i *i *i      : void glGetProgramResourceiv (GLuint, GLenum, GLuint, GLsizei, GLenum *, GLsizei, GLsizei *, GLint *);
glGetProgramResourceLocation > i i i *c            : GLint glGetProgramResourceLocation (GLuint, GLenum, GLchar *);
glGetProgramResourceLocationIndex > i i i *c       : GLint glGetProgramResourceLocationIndex (GLuint, GLenum, GLchar *);
...
glDebugMessageControl > n i i i i *i s             : void glDebugMessageControl (GLenum, GLenum, GLenum, GLsizei, GLuint *, GLboolean);
glDebugMessageInsert > n i i i i i *c              : void glDebugMessageInsert (GLenum, GLenum, GLuint, GLenum, GLsizei, GLchar *);
glDebugMessageCallback > n x *x                    : void glDebugMessageCallback (GLDEBUGPROC, void *);
...
glPushDebugGroup > n i i i *c                      : void glPushDebugGroup (GLenum, GLuint, GLsizei, GLchar *);
glPopDebugGroup > n                                : void glPopDebugGroup (void);
glObjectLabel > n i i i *c                         : void glObjectLabel (GLenum, GLuint, GLsizei, GLchar *);
glGetObjectLabel > n i i i *i *c                   : void glGetObjectLabel (GLenum, GLuint, GLsizei, GLsizei *, GLchar *);
glObjectPtrLabel > n *x i *c                       : void glObjectPtrLabel (void *, GLsizei, GLchar *);
glGetObjectPtrLabel > n *x i *i *c                 : void glGetObjectPtrLabel (void *, GLsizei, GLsizei *, GLchar *);
glBufferStorage > n i x *x i                       : void glBufferStorage (GLenum, GLsizeiptr, void *, GLbitfield);
glClearTexImage > n i i i i *x                     : void glClearTexImage (GLuint, GLint, GLenum, GLenum, void *);
glClearTexSubImage > n i i i i i i i i i i *x      : void glClearTexSubImage (GLuint, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLenum, void *);
glBindBuffersBase > n i i i *i                     : void glBindBuffersBase (GLenum, GLuint, GLsizei, GLuint *);
glBindBuffersRange > n i i i *i *x *x              : void glBindBuffersRange (GLenum, GLuint, GLsizei, GLuint *, GLintptr *, GLsizeiptr *);
glBindTextures > n i i *i                          : void glBindTextures (GLuint, GLsizei, GLuint *);
glBindSamplers > n i i *i                          : void glBindSamplers (GLuint, GLsizei, GLuint *);
glBindImageTextures > n i i *i                     : void glBindImageTextures (GLuint, GLsizei, GLuint *);
glBindVertexBuffers > n i i *i *x *i               : void glBindVertexBuffers (GLuint, GLsizei, GLuint *, GLintptr *, GLsizei *);
...
glNamedBufferStorage > n i i *x i                  : void glNamedBufferStorage (GLuint, GLsizei, void *, GLbitfield);
glNamedBufferData > n i i *x i                     : void glNamedBufferData (GLuint, GLsizei, void *, GLenum);
glNamedBufferSubData > n i x i *x                  : void glNamedBufferSubData (GLuint, GLintptr, GLsizei, void *);
glCopyNamedBufferSubData > n i i x x i             : void glCopyNamedBufferSubData (GLuint, GLuint, GLintptr, GLintptr, GLsizei);
glClearNamedBufferData > n i i i i *x              : void glClearNamedBufferData (GLuint, GLenum, GLenum, GLenum, void *);
glClearNamedBufferSubData > n i i x i i i *x       : void glClearNamedBufferSubData (GLuint, GLenum, GLintptr, GLsizei, GLenum, GLenum, void *);
...
glNamedFramebufferDrawBuffers > n i i *i           : void glNamedFramebufferDrawBuffers (GLuint, GLsizei, GLenum *);
glNamedFramebufferReadBuffer > n i i               : void glNamedFramebufferReadBuffer (GLuint, GLenum);
glInvalidateNamedFramebufferData > n i i *i        : void glInvalidateNamedFramebufferData (GLuint, GLsizei, GLenum *);
glInvalidateNamedFramebufferSubData > n i i *i i i i i : void glInvalidateNamedFramebufferSubData (GLuint, GLsizei, GLenum *, GLint, GLint, GLsizei, GLsizei);
glClearNamedFramebufferiv > n i i i *i             : void glClearNamedFramebufferiv (GLuint, GLenum, GLint, GLint *);
glClearNamedFramebufferuiv > n i i i *i            : void glClearNamedFramebufferuiv (GLuint, GLenum, GLint, GLuint *);
glClearNamedFramebufferfv > n i i i *f             : void glClearNamedFramebufferfv (GLuint, GLenum, GLint, GLfloat *);
glClearNamedFramebufferfi > n i i f i              : void glClearNamedFramebufferfi (GLuint, GLenum, GLfloat , GLint);
...
glTextureSubImage1D > n i i i i i i *x             : void glTextureSubImage1D (GLuint, GLint, GLint, GLsizei, GLenum, GLenum, void *);
glTextureSubImage2D > n i i i i i i i i *x         : void glTextureSubImage2D (GLuint, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, void *);
glTextureSubImage3D > n i i i i i i i i i i *x     : void glTextureSubImage3D (GLuint, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLenum, void *);
glCompressedTextureSubImage1D > n i i i i i i *x   : void glCompressedTextureSubImage1D (GLuint, GLint, GLint, GLsizei, GLenum, GLsizei, void *);
glCompressedTextureSubImage2D > n i i i i i i i i *x : void glCompressedTextureSubImage2D (GLuint, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLsizei, void *);
glCompressedTextureSubImage3D > n i i i i i i i i i i *x : void glCompressedTextureSubImage3D (GLuint, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLsizei, void *);
...
glTextureParameterfv > n i i *f                    : void glTextureParameterfv (GLuint, GLenum, GLfloat *);
glTextureParameteri > n i i i                      : void glTextureParameteri (GLuint, GLenum, GLint);
glTextureParameterIiv > n i i *i                   : void glTextureParameterIiv (GLuint, GLenum, GLint *);
glTextureParameterIuiv > n i i *i                  : void glTextureParameterIuiv (GLuint, GLenum, GLuint *);
glTextureParameteriv > n i i *i                    : void glTextureParameteriv (GLuint, GLenum, GLint *);
...
glVertexArrayVertexBuffers > n i i i *i *x *i      : void glVertexArrayVertexBuffers (GLuint, GLuint, GLsizei, GLuint *, GLintptr *, GLsizei *);
...
glUniformHandleui64vARB > n i i *l                 : void glUniformHandleui64vARB (GLint, GLsizei, GLuint64 *);
glProgramUniformHandleui64ARB > n i i l            : void glProgramUniformHandleui64ARB (GLuint, GLint, GLuint64);
glProgramUniformHandleui64vARB > n i i i *l        : void glProgramUniformHandleui64vARB (GLuint, GLint, GLsizei, GLuint64 *);
...
glVertexAttribL1ui64vARB > n i *l                  : void glVertexAttribL1ui64vARB (GLuint, GLuint64EXT *);
...
glDebugMessageCallbackARB > n x *x                 : void glDebugMessageCallbackARB (GLDEBUGPROCARB, void *);
...
glDrawElementsInstancedARB > n i i i *x i          : void glDrawElementsInstancedARB (GLenum, GLsizei, GLenum, void *, GLsizei);
glProgramStringARB > n i i i *x                    : void glProgramStringARB (GLenum, GLenum, GLsizei, void *);
...
glMatrixIndexPointerARB > n i i i *x               : void glMatrixIndexPointerARB (GLint, GLenum, GLsizei, void *);
...
glShaderSourceARB > n \1 i *x *i                   : void glShaderSourceARB (GLhandleARB, GLsizei, GLcharARB **, GLint *);
...
glGetUniformLocationARB > i \1 *c                  : GLint glGetUniformLocationARB (GLhandleARB, GLcharARB *);
...
glCompressedTexImage3DARB > n i i i i i i i i *x   : void glCompressedTexImage3DARB (GLenum, GLint, GLenum, GLsizei, GLsizei, GLsizei, GLint, GLsizei, void *);
glCompressedTexImage2DARB > n i i i i i i i *x     : void glCompressedTexImage2DARB (GLenum, GLint, GLenum, GLsizei, GLsizei, GLint, GLsizei, void *);
glCompressedTexImage1DARB > n i i i i i i *x       : void glCompressedTexImage1DARB (GLenum, GLint, GLenum, GLsizei, GLint, GLsizei, void *);
glCompressedTexSubImage3DARB > n i i i i i i i i i i *x : void glCompressedTexSubImage3DARB (GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLsizei, void *);
glCompressedTexSubImage2DARB > n i i i i i i i i *x : void glCompressedTexSubImage2DARB (GLenum, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLsizei, void *);
glCompressedTexSubImage1DARB > n i i i i i i *x    : void glCompressedTexSubImage1DARB (GLenum, GLint, GLint, GLsizei, GLenum, GLsizei, void *);
...
glWeightPointerARB > n i i i *x                    : void glWeightPointerARB (GLint, GLenum, GLsizei, void *);
...
glBufferDataARB > n i x *x i                       : void glBufferDataARB (GLenum, GLsizeiptrARB, void *, GLenum);
glBufferSubDataARB > n i x x *x                    : void glBufferSubDataARB (GLenum, GLintptrARB, GLsizeiptrARB, void *);
...
glVertexAttribPointerARB > n i i i s i *x          : void glVertexAttribPointerARB (GLuint, GLint, GLenum, GLboolean, GLsizei, void *);
...
glBindAttribLocationARB > n \1 i *c                : void glBindAttribLocationARB (GLhandleARB, GLuint, GLcharARB *);
glGetActiveAttribARB > n \1 i i *i *i *i *c        : void glGetActiveAttribARB (GLhandleARB, GLuint, GLsizei, GLsizei *, GLint *, GLenum *, GLcharARB *);
glGetAttribLocationARB > i \1 *c                   : GLint glGetAttribLocationARB (GLhandleARB, GLcharARB *);
...
glClipPlanexOES > n i *i                           : void glClipPlanexOES (GLenum, GLfixed *);
...
glFogxvOES > n i *i                                : void glFogxvOES (GLenum, GLfixed *);
...
glLightModelxvOES > n i *i                         : void glLightModelxvOES (GLenum, GLfixed *);
glLightxOES > n i i i                              : void glLightxOES (GLenum, GLenum, GLfixed);
glLightxvOES > n i i *i                            : void glLightxvOES (GLenum, GLenum, GLfixed *);
glLineWidthxOES > n i                              : void glLineWidthxOES (GLfixed);
glLoadMatrixxOES > n *i                            : void glLoadMatrixxOES (GLfixed *);
glMaterialxOES > n i i i                           : void glMaterialxOES (GLenum, GLenum, GLfixed);
glMaterialxvOES > n i i *i                         : void glMaterialxvOES (GLenum, GLenum, GLfixed *);
glMultMatrixxOES > n *i                            : void glMultMatrixxOES (GLfixed *);
...
glPointParameterxvOES > n i *i                     : void glPointParameterxvOES (GLenum, GLfixed *);
...
glTexEnvxvOES > n i i *i                           : void glTexEnvxvOES (GLenum, GLenum, GLfixed *);
glTexParameterxOES > n i i i                       : void glTexParameterxOES (GLenum, GLenum, GLfixed);
glTexParameterxvOES > n i i *i                     : void glTexParameterxvOES (GLenum, GLenum, GLfixed *);
glTranslatexOES > n i i i                          : void glTranslatexOES (GLfixed, GLfixed, GLfixed);
glAccumxOES > n i i                                : void glAccumxOES (GLenum, GLfixed);
glBitmapxOES > n i i i i i i *c                    : void glBitmapxOES (GLsizei, GLsizei, GLfixed, GLfixed, GLfixed, GLfixed, GLubyte *);
...
glColor3xvOES > n *i                               : void glColor3xvOES (GLfixed *);
glColor4xvOES > n *i                               : void glColor4xvOES (GLfixed *);
glConvolutionParameterxOES > n i i i               : void glConvolutionParameterxOES (GLenum, GLenum, GLfixed);
glConvolutionParameterxvOES > n i i *i             : void glConvolutionParameterxvOES (GLenum, GLenum, GLfixed *);
glEvalCoord1xOES > n i                             : void glEvalCoord1xOES (GLfixed);
glEvalCoord1xvOES > n *i                           : void glEvalCoord1xvOES (GLfixed *);
glEvalCoord2xOES > n i i                           : void glEvalCoord2xOES (GLfixed, GLfixed);
glEvalCoord2xvOES > n *i                           : void glEvalCoord2xvOES (GLfixed *);
glFeedbackBufferxOES > n i i *i                    : void glFeedbackBufferxOES (GLsizei, GLenum, GLfixed *);
...
glIndexxvOES > n *i                                : void glIndexxvOES (GLfixed *);
glLoadTransposeMatrixxOES > n *i                   : void glLoadTransposeMatrixxOES (GLfixed *);
...
glMultTransposeMatrixxOES > n *i                   : void glMultTransposeMatrixxOES (GLfixed *);
glMultiTexCoord1xOES > n i i                       : void glMultiTexCoord1xOES (GLenum, GLfixed);
glMultiTexCoord1xvOES > n i *i                     : void glMultiTexCoord1xvOES (GLenum, GLfixed *);
glMultiTexCoord2xOES > n i i i                     : void glMultiTexCoord2xOES (GLenum, GLfixed, GLfixed);
glMultiTexCoord2xvOES > n i *i                     : void glMultiTexCoord2xvOES (GLenum, GLfixed *);
glMultiTexCoord3xOES > n i i i i                   : void glMultiTexCoord3xOES (GLenum, GLfixed, GLfixed, GLfixed);
glMultiTexCoord3xvOES > n i *i                     : void glMultiTexCoord3xvOES (GLenum, GLfixed *);
glMultiTexCoord4xvOES > n i *i                     : void glMultiTexCoord4xvOES (GLenum, GLfixed *);
glNormal3xvOES > n *i                              : void glNormal3xvOES (GLfixed *);
glPassThroughxOES > n i                            : void glPassThroughxOES (GLfixed);
glPixelMapx > n i i *i                             : void glPixelMapx (GLenum, GLint, GLfixed *);
...
glMultiDrawArraysIndirectAMD > n i *x i i          : void glMultiDrawArraysIndirectAMD (GLenum, void *, GLsizei, GLsizei);
glMultiDrawElementsIndirectAMD > n i i *x i i      : void glMultiDrawElementsIndirectAMD (GLenum, GLenum, void *, GLsizei, GLsizei);
...
glElementPointerAPPLE > n i *x                     : void glElementPointerAPPLE (GLenum, void *);
...
glTextureRangeAPPLE > n i i *x                     : void glTextureRangeAPPLE (GLenum, GLsizei, void *);
...
glElementPointerATI > n i *x                       : void glElementPointerATI (GLenum, void *);
...
glNewObjectBufferATI > i i *x i                    : GLuint glNewObjectBufferATI (GLsizei, void *, GLenum);
glIsObjectBufferATI > s i                          : GLboolean glIsObjectBufferATI (GLuint);
glUpdateObjectBufferATI > n i i i *x i             : void glUpdateObjectBufferATI (GLuint, GLuint, GLsizei, void *, GLenum);
...
glColorSubTableEXT > n i i i i i *x                : void glColorSubTableEXT (GLenum, GLsizei, GLsizei, GLenum, GLenum, void *);
...
glConvolutionFilter1DEXT > n i i i i i *x          : void glConvolutionFilter1DEXT (GLenum, GLenum, GLsizei, GLenum, GLenum, void *);
glConvolutionFilter2DEXT > n i i i i i i *x        : void glConvolutionFilter2DEXT (GLenum, GLenum, GLsizei, GLsizei, GLenum, GLenum, void *);
...
glSeparableFilter2DEXT > n i i i i i i *x *x       : void glSeparableFilter2DEXT (GLenum, GLenum, GLsizei, GLsizei, GLenum, GLenum, void *, void *);
...
glTangentPointerEXT > n i i *x                     : void glTangentPointerEXT (GLenum, GLsizei, void *);
glBinormalPointerEXT > n i i *x                    : void glBinormalPointerEXT (GLenum, GLsizei, void *);
...
glLabelObjectEXT > n i i i *c                      : void glLabelObjectEXT (GLenum, GLuint, GLsizei, GLchar *);
glGetObjectLabelEXT > n i i i *i *c                : void glGetObjectLabelEXT (GLenum, GLuint, GLsizei, GLsizei *, GLchar *);
glInsertEventMarkerEXT > n i *c                    : void glInsertEventMarkerEXT (GLsizei, GLchar *);
glPushGroupMarkerEXT > n i *c                      : void glPushGroupMarkerEXT (GLsizei, GLchar *);
...
glTextureImage1DEXT > n i i i i i i i i *x         : void glTextureImage1DEXT (GLuint, GLenum, GLint, GLint, GLsizei, GLint, GLenum, GLenum, void *);
glTextureImage2DEXT > n i i i i i i i i i *x       : void glTextureImage2DEXT (GLuint, GLenum, GLint, GLint, GLsizei, GLsizei, GLint, GLenum, GLenum, void *);
glTextureSubImage1DEXT > n i i i i i i i *x        : void glTextureSubImage1DEXT (GLuint, GLenum, GLint, GLint, GLsizei, GLenum, GLenum, void *);
glTextureSubImage2DEXT > n i i i i i i i i i *x    : void glTextureSubImage2DEXT (GLuint, GLenum, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, void *);
...
glTextureImage3DEXT > n i i i i i i i i i i *x     : void glTextureImage3DEXT (GLuint, GLenum, GLint, GLint, GLsizei, GLsizei, GLsizei, GLint, GLenum, GLenum, void *);
glTextureSubImage3DEXT > n i i i i i i i i i i i *x : void glTextureSubImage3DEXT (GLuint, GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLenum, void *);
...
glMultiTexCoordPointerEXT > n i i i i *x           : void glMultiTexCoordPointerEXT (GLenum, GLint, GLenum, GLsizei, void *);
...
glMultiTexImage1DEXT > n i i i i i i i i *x        : void glMultiTexImage1DEXT (GLenum, GLenum, GLint, GLint, GLsizei, GLint, GLenum, GLenum, void *);
glMultiTexImage2DEXT > n i i i i i i i i i *x      : void glMultiTexImage2DEXT (GLenum, GLenum, GLint, GLint, GLsizei, GLsizei, GLint, GLenum, GLenum, void *);
glMultiTexSubImage1DEXT > n i i i i i i i *x       : void glMultiTexSubImage1DEXT (GLenum, GLenum, GLint, GLint, GLsizei, GLenum, GLenum, void *);
glMultiTexSubImage2DEXT > n i i i i i i i i i *x   : void glMultiTexSubImage2DEXT (GLenum, GLenum, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, void *);
...
glMultiTexImage3DEXT > n i i i i i i i i i i *x    : void glMultiTexImage3DEXT (GLenum, GLenum, GLint, GLint, GLsizei, GLsizei, GLsizei, GLint, GLenum, GLenum, void *);
glMultiTexSubImage3DEXT > n i i i i i i i i i i i *x : void glMultiTexSubImage3DEXT (GLenum, GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLenum, void *);
...
glCompressedTextureImage3DEXT > n i i i i i i i i i *x : void glCompressedTextureImage3DEXT (GLuint, GLenum, GLint, GLenum, GLsizei, GLsizei, GLsizei, GLint, GLsizei, void *);
glCompressedTextureImage2DEXT > n i i i i i i i i *x : void glCompressedTextureImage2DEXT (GLuint, GLenum, GLint, GLenum, GLsizei, GLsizei, GLint, GLsizei, void *);
glCompressedTextureImage1DEXT > n i i i i i i i *x : void glCompressedTextureImage1DEXT (GLuint, GLenum, GLint, GLenum, GLsizei, GLint, GLsizei, void *);
glCompressedTextureSubImage3DEXT > n i i i i i i i i i i i *x : void glCompressedTextureSubImage3DEXT (GLuint, GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLsizei, void *);
glCompressedTextureSubImage2DEXT > n i i i i i i i i i *x : void glCompressedTextureSubImage2DEXT (GLuint, GLenum, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLsizei, void *);
glCompressedTextureSubImage1DEXT > n i i i i i i i *x : void glCompressedTextureSubImage1DEXT (GLuint, GLenum, GLint, GLint, GLsizei, GLenum, GLsizei, void *);
glGetCompressedTextureImageEXT > n i i i *x        : void glGetCompressedTextureImageEXT (GLuint, GLenum, GLint, void *);
glCompressedMultiTexImage3DEXT > n i i i i i i i i i *x : void glCompressedMultiTexImage3DEXT (GLenum, GLenum, GLint, GLenum, GLsizei, GLsizei, GLsizei, GLint, GLsizei, void *);
glCompressedMultiTexImage2DEXT > n i i i i i i i i *x : void glCompressedMultiTexImage2DEXT (GLenum, GLenum, GLint, GLenum, GLsizei, GLsizei, GLint, GLsizei, void *);
glCompressedMultiTexImage1DEXT > n i i i i i i i *x : void glCompressedMultiTexImage1DEXT (GLenum, GLenum, GLint, GLenum, GLsizei, GLint, GLsizei, void *);
glCompressedMultiTexSubImage3DEXT > n i i i i i i i i i i i *x : void glCompressedMultiTexSubImage3DEXT (GLenum, GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLsizei, void *);
glCompressedMultiTexSubImage2DEXT > n i i i i i i i i i *x : void glCompressedMultiTexSubImage2DEXT (GLenum, GLenum, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLsizei, void *);
glCompressedMultiTexSubImage1DEXT > n i i i i i i i *x : void glCompressedMultiTexSubImage1DEXT (GLenum, GLenum, GLint, GLint, GLsizei, GLenum, GLsizei, void *);
...
glNamedBufferDataEXT > n i x *x i                  : void glNamedBufferDataEXT (GLuint, GLsizeiptr, void *, GLenum);
glNamedBufferSubDataEXT > n i x x *x               : void glNamedBufferSubDataEXT (GLuint, GLintptr, GLsizeiptr, void *);
...
glNamedProgramStringEXT > n i i i i *x             : void glNamedProgramStringEXT (GLuint, GLenum, GLenum, GLsizei, void *);
...
glNamedBufferStorageEXT > n i x *x i               : void glNamedBufferStorageEXT (GLuint, GLsizeiptr, void *, GLbitfield);
glClearNamedBufferDataEXT > n i i i i *x           : void glClearNamedBufferDataEXT (GLuint, GLenum, GLenum, GLenum, void *);
glClearNamedBufferSubDataEXT > n i i x x i i *x    : void glClearNamedBufferSubDataEXT (GLuint, GLenum, GLsizeiptr, GLsizeiptr, GLenum, GLenum, void *);
...
glDrawElementsInstancedEXT > n i i i *x i          : void glDrawElementsInstancedEXT (GLenum, GLsizei, GLenum, void *, GLsizei);
glDrawRangeElementsEXT > n i i i i i *x            : void glDrawRangeElementsEXT (GLenum, GLuint, GLuint, GLsizei, GLenum, void *);
...
glFogCoordPointerEXT > n i i *x                    : void glFogCoordPointerEXT (GLenum, GLsizei, void *);
...
glMultiDrawElementsEXT > n i *i i *x i             : void glMultiDrawElementsEXT (GLenum, GLsizei *, GLenum, void **, GLsizei);
glSampleMaskEXT > n f s                            : void glSampleMaskEXT (GLclampf, GLboolean);
glSamplePatternEXT > n i                           : void glSamplePatternEXT (GLenum);
glColorTableEXT > n i i i i i *x                   : void glColorTableEXT (GLenum, GLenum, GLsizei, GLenum, GLenum, void *);
...
glSecondaryColorPointerEXT > n i i i *x            : void glSecondaryColorPointerEXT (GLint, GLenum, GLsizei, void *);
...
glTexSubImage1DEXT > n i i i i i i *x              : void glTexSubImage1DEXT (GLenum, GLint, GLint, GLsizei, GLenum, GLenum, void *);
glTexSubImage2DEXT > n i i i i i i i i *x          : void glTexSubImage2DEXT (GLenum, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, void *);
glTexImage3DEXT > n i i i i i i i i i *x           : void glTexImage3DEXT (GLenum, GLint, GLenum, GLsizei, GLsizei, GLsizei, GLint, GLenum, GLenum, void *);
glTexSubImage3DEXT > n i i i i i i i i i i *x      : void glTexSubImage3DEXT (GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLenum, void *);
...
glColorPointerEXT > n i i i i *x                   : void glColorPointerEXT (GLint, GLenum, GLsizei, GLsizei, void *);
...
glIndexPointerEXT > n i i i *x                     : void glIndexPointerEXT (GLenum, GLsizei, GLsizei, void *);
glNormalPointerEXT > n i i i *x                    : void glNormalPointerEXT (GLenum, GLsizei, GLsizei, void *);
glTexCoordPointerEXT > n i i i i *x                : void glTexCoordPointerEXT (GLint, GLenum, GLsizei, GLsizei, void *);
glVertexPointerEXT > n i i i i *x                  : void glVertexPointerEXT (GLint, GLenum, GLsizei, GLsizei, void *);
...
glVertexAttribLPointerEXT > n i i i i *x           : void glVertexAttribLPointerEXT (GLuint, GLint, GLenum, GLsizei, void *);
...
glSetInvariantEXT > n i i *x                       : void glSetInvariantEXT (GLuint, GLenum, void *);
glSetLocalConstantEXT > n i i *x                   : void glSetLocalConstantEXT (GLuint, GLenum, void *);
...
glVariantPointerEXT > n i i i *x                   : void glVariantPointerEXT (GLuint, GLenum, GLuint, void *);
...
glVertexWeightPointerEXT > n i i i *x              : void glVertexWeightPointerEXT (GLint, GLenum, GLsizei, void *);
...
glStringMarkerGREMEDY > n i *x                     : void glStringMarkerGREMEDY (GLsizei, void *);
...
glMultiModeDrawElementsIBM > n *i *i i *x i i      : void glMultiModeDrawElementsIBM (GLenum *, GLsizei *, GLenum, void **, GLsizei, GLint);
glFlushStaticDataIBM > n i                         : void glFlushStaticDataIBM (GLenum);
glColorPointerListIBM > n i i i *x i               : void glColorPointerListIBM (GLint, GLenum, GLint, void **, GLint);
glSecondaryColorPointerListIBM > n i i i *x i      : void glSecondaryColorPointerListIBM (GLint, GLenum, GLint, void **, GLint);
glEdgeFlagPointerListIBM > n i *x i                : void glEdgeFlagPointerListIBM (GLint, GLboolean **, GLint);
glFogCoordPointerListIBM > n i i *x i              : void glFogCoordPointerListIBM (GLenum, GLint, void **, GLint);
glIndexPointerListIBM > n i i *x i                 : void glIndexPointerListIBM (GLenum, GLint, void **, GLint);
glNormalPointerListIBM > n i i *x i                : void glNormalPointerListIBM (GLenum, GLint, void **, GLint);
glTexCoordPointerListIBM > n i i i *x i            : void glTexCoordPointerListIBM (GLint, GLenum, GLint, void **, GLint);
glVertexPointerListIBM > n i i i *x i              : void glVertexPointerListIBM (GLint, GLenum, GLint, void **, GLint);
...
glVertexPointervINTEL > n i i *x                   : void glVertexPointervINTEL (GLint, GLenum, void **);
glNormalPointervINTEL > n i *x                     : void glNormalPointervINTEL (GLenum, void **);
glColorPointervINTEL > n i i *x                    : void glColorPointervINTEL (GLint, GLenum, void **);
glTexCoordPointervINTEL > n i i *x                 : void glTexCoordPointervINTEL (GLint, GLenum, void **);
...
glMultiDrawArraysIndirectBindlessNV > n i *x i i i : void glMultiDrawArraysIndirectBindlessNV (GLenum, void *, GLsizei, GLsizei, GLint);
glMultiDrawElementsIndirectBindlessNV > n i i *x i i i : void glMultiDrawElementsIndirectBindlessNV (GLenum, GLenum, void *, GLsizei, GLsizei, GLint);
glMultiDrawArraysIndirectBindlessCountNV > n i *x i i i i : void glMultiDrawArraysIndirectBindlessCountNV (GLenum, void *, GLsizei, GLsizei, GLsizei, GLint);
glMultiDrawElementsIndirectBindlessCountNV > n i i *x i i i i : void glMultiDrawElementsIndirectBindlessCountNV (GLenum, GLenum, void *, GLsizei, GLsizei, GLsizei, GLint);
...
glUniformHandleui64vNV > n i i *l                  : void glUniformHandleui64vNV (GLint, GLsizei, GLuint64 *);
glProgramUniformHandleui64NV > n i i l             : void glProgramUniformHandleui64NV (GLuint, GLint, GLuint64);
glProgramUniformHandleui64vNV > n i i i *l         : void glProgramUniformHandleui64vNV (GLuint, GLint, GLsizei, GLuint64 *);
...
glMapControlPointsNV > n i i i i i i i s *x        : void glMapControlPointsNV (GLenum, GLuint, GLenum, GLsizei, GLsizei, GLint, GLint, GLboolean, void *);
...
glVertex2hvNV > n *s                               : void glVertex2hvNV (GLhalfNV *);
glVertex3hNV > n s s s                             : void glVertex3hNV (GLhalfNV, GLhalfNV, GLhalfNV);
glVertex3hvNV > n *s                               : void glVertex3hvNV (GLhalfNV *);
glVertex4hNV > n s s s s                           : void glVertex4hNV (GLhalfNV, GLhalfNV, GLhalfNV, GLhalfNV);
glVertex4hvNV > n *s                               : void glVertex4hvNV (GLhalfNV *);
glNormal3hNV > n s s s                             : void glNormal3hNV (GLhalfNV, GLhalfNV, GLhalfNV);
glNormal3hvNV > n *s                               : void glNormal3hvNV (GLhalfNV *);
glColor3hNV > n s s s                              : void glColor3hNV (GLhalfNV, GLhalfNV, GLhalfNV);
glColor3hvNV > n *s                                : void glColor3hvNV (GLhalfNV *);
glColor4hNV > n s s s s                            : void glColor4hNV (GLhalfNV, GLhalfNV, GLhalfNV, GLhalfNV);
glColor4hvNV > n *s                                : void glColor4hvNV (GLhalfNV *);
glTexCoord1hNV > n s                               : void glTexCoord1hNV (GLhalfNV);
glTexCoord1hvNV > n *s                             : void glTexCoord1hvNV (GLhalfNV *);
glTexCoord2hNV > n s s                             : void glTexCoord2hNV (GLhalfNV, GLhalfNV);
glTexCoord2hvNV > n *s                             : void glTexCoord2hvNV (GLhalfNV *);
glTexCoord3hNV > n s s s                           : void glTexCoord3hNV (GLhalfNV, GLhalfNV, GLhalfNV);
glTexCoord3hvNV > n *s                             : void glTexCoord3hvNV (GLhalfNV *);
glTexCoord4hNV > n s s s s                         : void glTexCoord4hNV (GLhalfNV, GLhalfNV, GLhalfNV, GLhalfNV);
glTexCoord4hvNV > n *s                             : void glTexCoord4hvNV (GLhalfNV *);
glMultiTexCoord1hNV > n i s                        : void glMultiTexCoord1hNV (GLenum, GLhalfNV);
glMultiTexCoord1hvNV > n i *s                      : void glMultiTexCoord1hvNV (GLenum, GLhalfNV *);
glMultiTexCoord2hNV > n i s s                      : void glMultiTexCoord2hNV (GLenum, GLhalfNV, GLhalfNV);
glMultiTexCoord2hvNV > n i *s                      : void glMultiTexCoord2hvNV (GLenum, GLhalfNV *);
glMultiTexCoord3hNV > n i s s s                    : void glMultiTexCoord3hNV (GLenum, GLhalfNV, GLhalfNV, GLhalfNV);
glMultiTexCoord3hvNV > n i *s                      : void glMultiTexCoord3hvNV (GLenum, GLhalfNV *);
glMultiTexCoord4hNV > n i s s s s                  : void glMultiTexCoord4hNV (GLenum, GLhalfNV, GLhalfNV, GLhalfNV, GLhalfNV);
glMultiTexCoord4hvNV > n i *s                      : void glMultiTexCoord4hvNV (GLenum, GLhalfNV *);
glFogCoordhNV > n s                                : void glFogCoordhNV (GLhalfNV);
glFogCoordhvNV > n *s                              : void glFogCoordhvNV (GLhalfNV *);
glSecondaryColor3hNV > n s s s                     : void glSecondaryColor3hNV (GLhalfNV, GLhalfNV, GLhalfNV);
glSecondaryColor3hvNV > n *s                       : void glSecondaryColor3hvNV (GLhalfNV *);
glVertexWeighthNV > n s                            : void glVertexWeighthNV (GLhalfNV);
glVertexWeighthvNV > n *s                          : void glVertexWeighthvNV (GLhalfNV *);
glVertexAttrib1hNV > n i s                         : void glVertexAttrib1hNV (GLuint, GLhalfNV);
glVertexAttrib1hvNV > n i *s                       : void glVertexAttrib1hvNV (GLuint, GLhalfNV *);
glVertexAttrib2hNV > n i s s                       : void glVertexAttrib2hNV (GLuint, GLhalfNV, GLhalfNV);
glVertexAttrib2hvNV > n i *s                       : void glVertexAttrib2hvNV (GLuint, GLhalfNV *);
glVertexAttrib3hNV > n i s s s                     : void glVertexAttrib3hNV (GLuint, GLhalfNV, GLhalfNV, GLhalfNV);
glVertexAttrib3hvNV > n i *s                       : void glVertexAttrib3hvNV (GLuint, GLhalfNV *);
glVertexAttrib4hNV > n i s s s s                   : void glVertexAttrib4hNV (GLuint, GLhalfNV, GLhalfNV, GLhalfNV, GLhalfNV);
glVertexAttrib4hvNV > n i *s                       : void glVertexAttrib4hvNV (GLuint, GLhalfNV *);
glVertexAttribs1hvNV > n i i *s                    : void glVertexAttribs1hvNV (GLuint, GLsizei, GLhalfNV *);
glVertexAttribs2hvNV > n i i *s                    : void glVertexAttribs2hvNV (GLuint, GLsizei, GLhalfNV *);
glVertexAttribs3hvNV > n i i *s                    : void glVertexAttribs3hvNV (GLuint, GLsizei, GLhalfNV *);
glVertexAttribs4hvNV > n i i *s                    : void glVertexAttribs4hvNV (GLuint, GLsizei, GLhalfNV *);
...
glPathCommandsNV > n i i *c i i *x                 : void glPathCommandsNV (GLuint, GLsizei, GLubyte *, GLsizei, GLenum, void *);
glPathCoordsNV > n i i i *x                        : void glPathCoordsNV (GLuint, GLsizei, GLenum, void *);
glPathSubCommandsNV > n i i i i *c i i *x          : void glPathSubCommandsNV (GLuint, GLsizei, GLsizei, GLsizei, GLubyte *, GLsizei, GLenum, void *);
glPathSubCoordsNV > n i i i i *x                   : void glPathSubCoordsNV (GLuint, GLsizei, GLsizei, GLenum, void *);
glPathStringNV > n i i i *x                        : void glPathStringNV (GLuint, GLenum, GLsizei, void *);
glPathGlyphsNV > n i i *x i i i *x i i f           : void glPathGlyphsNV (GLuint, GLenum, void *, GLbitfield, GLsizei, GLenum, void *, GLenum, GLuint, GLfloat);
glPathGlyphRangeNV > n i i *x i i i i i f          : void glPathGlyphRangeNV (GLuint, GLenum, void *, GLbitfield, GLuint, GLsizei, GLenum, GLuint, GLfloat);
glWeightPathsNV > n i i *i *f                      : void glWeightPathsNV (GLuint, GLsizei, GLuint *, GLfloat *);
...
glTransformPathNV > n i i i *f                     : void glTransformPathNV (GLuint, GLuint, GLenum, GLfloat *);
glPathParameterivNV > n i i *i                     : void glPathParameterivNV (GLuint, GLenum, GLint *);
glPathParameteriNV > n i i i                       : void glPathParameteriNV (GLuint, GLenum, GLint);
glPathParameterfvNV > n i i *f                     : void glPathParameterfvNV (GLuint, GLenum, GLfloat *);
glPathParameterfNV > n i i f                       : void glPathParameterfNV (GLuint, GLenum, GLfloat);
glPathDashArrayNV > n i i *f                       : void glPathDashArrayNV (GLuint, GLsizei, GLfloat *);
...
glStencilFillPathInstancedNV > n i i *x i i i i *f : void glStencilFillPathInstancedNV (GLsizei, GLenum, void *, GLuint, GLenum, GLuint, GLenum, GLfloat *);
glStencilStrokePathInstancedNV > n i i *x i i i i *f : void glStencilStrokePathInstancedNV (GLsizei, GLenum, void *, GLuint, GLint, GLuint, GLenum, GLfloat *);
glPathCoverDepthFuncNV > n i                       : void glPathCoverDepthFuncNV (GLenum);
glPathColorGenNV > n i i i *f                      : void glPathColorGenNV (GLenum, GLenum, GLenum, GLfloat *);
glPathTexGenNV > n i i i *f                        : void glPathTexGenNV (GLenum, GLenum, GLint, GLfloat *);
...
glCoverFillPathInstancedNV > n i i *x i i i *f     : void glCoverFillPathInstancedNV (GLsizei, GLenum, void *, GLuint, GLenum, GLenum, GLfloat *);
glCoverStrokePathInstancedNV > n i i *x i i i *f   : void glCoverStrokePathInstancedNV (GLsizei, GLenum, void *, GLuint, GLenum, GLenum, GLfloat *);
...
glGetPathMetricsNV > n i i i *x i i *f             : void glGetPathMetricsNV (GLbitfield, GLsizei, GLenum, void *, GLuint, GLsizei, GLfloat *);
glGetPathMetricRangeNV > n i i i i *f              : void glGetPathMetricRangeNV (GLbitfield, GLuint, GLsizei, GLsizei, GLfloat *);
glGetPathSpacingNV > n i i i *x i f f i *f         : void glGetPathSpacingNV (GLenum, GLsizei, GLenum, void *, GLuint, GLfloat, GLfloat, GLenum, GLfloat *);
...
glMatrixLoad3x2fNV > n i *f                        : void glMatrixLoad3x2fNV (GLenum, GLfloat *);
glMatrixLoad3x3fNV > n i *f                        : void glMatrixLoad3x3fNV (GLenum, GLfloat *);
glMatrixLoadTranspose3x3fNV > n i *f               : void glMatrixLoadTranspose3x3fNV (GLenum, GLfloat *);
glMatrixMult3x2fNV > n i *f                        : void glMatrixMult3x2fNV (GLenum, GLfloat *);
glMatrixMult3x3fNV > n i *f                        : void glMatrixMult3x3fNV (GLenum, GLfloat *);
glMatrixMultTranspose3x3fNV > n i *f               : void glMatrixMultTranspose3x3fNV (GLenum, GLfloat *);
...
glStencilThenCoverFillPathInstancedNV > n i i *x i i i i i *f : void glStencilThenCoverFillPathInstancedNV (GLsizei, GLenum, void *, GLuint, GLenum, GLuint, GLenum, GLenum, GLfloat *);
glStencilThenCoverStrokePathInstancedNV > n i i *x i i i i i *f : void glStencilThenCoverStrokePathInstancedNV (GLsizei, GLenum, void *, GLuint, GLint, GLuint, GLenum, GLenum, GLfloat *);
glPathGlyphIndexRangeNV > i i *x i i f *i          : GLenum glPathGlyphIndexRangeNV (GLenum, void *, GLbitfield, GLuint, GLfloat, GLuint *);
glPathGlyphIndexArrayNV > i i i *x i i i i f       : GLenum glPathGlyphIndexArrayNV (GLuint, GLenum, void *, GLbitfield, GLuint, GLsizei, GLuint, GLfloat);
glPathMemoryGlyphIndexArrayNV > i i i x *x i i i i f : GLenum glPathMemoryGlyphIndexArrayNV (GLuint, GLenum, GLsizeiptr, void *, GLsizei, GLuint, GLsizei, GLuint, GLfloat);
glProgramPathFragmentInputGenNV > n i i i i *f     : void glProgramPathFragmentInputGenNV (GLuint, GLint, GLenum, GLint, GLfloat *);
glGetProgramResourcefvNV > n i i i i *i i *i *f    : void glGetProgramResourcefvNV (GLuint, GLenum, GLuint, GLsizei, GLenum *, GLsizei, GLsizei *, GLfloat *);
glPixelDataRangeNV > n i i *x                      : void glPixelDataRangeNV (GLenum, GLsizei, void *);
...
glTransformFeedbackAttribsNV > n i *i i            : void glTransformFeedbackAttribsNV (GLsizei, GLint *, GLenum);
...
glVDPAUInitNV > n *x *x                            : void glVDPAUInitNV (void *, void *);
glVDPAUFiniNV > n                                  : void glVDPAUFiniNV (void);
glVDPAURegisterVideoSurfaceNV > x *x i i *i        : GLvdpauSurfaceNV glVDPAURegisterVideoSurfaceNV (void *, GLenum, GLsizei, GLuint *);
glVDPAURegisterOutputSurfaceNV > x *x i i *i       : GLvdpauSurfaceNV glVDPAURegisterOutputSurfaceNV (void *, GLenum, GLsizei, GLuint *);
...
glVertexArrayRangeNV > n i *x                      : void glVertexArrayRangeNV (GLsizei, void *);
...
glVertexAttribPointerNV > n i i i i *x             : void glVertexAttribPointerNV (GLuint, GLint, GLenum, GLsizei, void *);
...
glVertexAttribIPointerEXT > n i i i i *x           : void glVertexAttribIPointerEXT (GLuint, GLint, GLenum, GLsizei, void *);
...
glTexImage4DSGIS > n i i i i i i i i i i *x        : void glTexImage4DSGIS (GLenum, GLint, GLenum, GLsizei, GLsizei, GLsizei, GLsizei, GLint, GLenum, GLenum, void *);
glTexSubImage4DSGIS > n i i i i i i i i i i i i *x : void glTexSubImage4DSGIS (GLenum, GLint, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLsizei, GLenum, GLenum, void *);
...
glIglooInterfaceSGIX > n i *x                      : void glIglooInterfaceSGIX (GLenum, void *);
...
glColorTableSGI > n i i i i i *x                   : void glColorTableSGI (GLenum, GLenum, GLsizei, GLenum, GLenum, void *);
...
glReplacementCodePointerSUN > n i i *x             : void glReplacementCodePointerSUN (GLenum, GLsizei, void **);
